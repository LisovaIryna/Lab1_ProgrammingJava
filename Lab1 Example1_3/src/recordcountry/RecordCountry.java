...
public class RecordCountry {
    ...
    int nom = -1;   // -1 - страна с искомым названием отстутствует
    for (int i=0; i<country.length; i++)
